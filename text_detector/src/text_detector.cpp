...
void TextDetectorNode::init(ros::NodeHandle& nh) {
    int h_min, s_min, v_min;
    int h_max, s_max, v_max;
    int canny_lower, canny_upper, canny_ker;
    int min_contour_area;

    img_sub_ = nh.subscribe("image_raw", 1, &TextDetectorNode::imageCallback, this);
...
void TextDetectorNode::imageCallback(const sensor_msgs::ImageConstPtr& msg) {
